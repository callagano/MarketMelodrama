...
export default function ImmediateDataTest() {
  // Set data immediately without useEffect or setTimeout
  const activePiecesData: ActivePiecesData = {
    ...
    <div className={styles.widget}>
      <div className={styles.content}>
        <div className={styles.section}>
          <h2 className="title">The brief (IMMEDIATE DATA TEST)</h2>
